...
public class EyesFragment extends Fragment { // main fragment start
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Functions.readFile(mEmoteList, getString(R.string.eyesFile), getContext(), getActivity(), root.getRootView()); // read this fragment's data file and load the necessary buttons
            ...
            public void onClick(View view) {
                ...
                mBtnScriptApply.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        nb.setOnLongClickListener(new View.OnLongClickListener() {
                            @Override
                            public boolean onLongClick(View v) {
                                // TODO Auto-generated method stub - add individual button removal (requires ID system)
                                return true;
                            }
                        });
                        try {
